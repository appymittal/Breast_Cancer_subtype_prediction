...
class SingleOmicsClassifier(nn.Module):
    def __init__(self,
                 rna_exp_dim=20000,
                 latent_dim=64,
                 num_classes=4):
...
class SingleOmicsClassifierCNN(nn.Module):
    def __init__(self,
                 rna_exp_dim=20000,
                 latent_dim=64,
                 num_classes=4):
        ...
        self.rna_vae = RNACNNEncoder(rna_exp_dim, latent_dim)
    ...
    def forward(self, rna):
        # Encode and normalize each modality
        z_rna = self.norm_rna(self.rna_vae(rna))
